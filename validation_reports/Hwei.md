...
- Hwei, **Hwei's** positive mood, is placed between his other two negative moods, Hwei and Hwei. This fact stems from lore implications, namely his inner turmoil, as detailed in his universe short stories: "Hwei faces the conflicting hues of Ionia" in The_Visionary and "Art saves me, yet it can shatter me" in Paintings_Framed_in_Half-Light.
...
== Champion skins ==
:_This article section only contains champion skins. For all associated collection items, see Hwei_(Collection)._
