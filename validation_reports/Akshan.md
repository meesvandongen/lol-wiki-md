...
- **Akshan** will not stop swinging until his dash is stopped.
  - The swing will end prematurely if the terrain the hook was attached to no longer exists, such as player-generated_terrain.
...
- **Akshan** can fire at any targetable enemy unit excluding structures and jungle_plants.
...
- A kill threshold will appear on the health_bar of the target locked onto during the channel, which increases each time **Akshan** stores a bullet. If the target's **current** health falls below the threshold, their health bar will be framed in red.
  - The indicator factors the bonus damage applied by Akshan as well as damage_modifiers and the target's resistances.
