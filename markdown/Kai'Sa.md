...
- Her name's current form follows the Ancient Shuriman naming convention for Void Crest icon.png.
- Her accent is Afrikaner.
- She is the first champion to receive Chroma variants upon release.
- She uses a Rift Frog profileicon.png in one of her animations, along with Morgana and Thresh.
