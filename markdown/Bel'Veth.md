...
| **Attack Damage** | $60.0$ | $+1.0$ | $77.0$ |
| **Attack Speed** | $0.850$ | $+0.0\%$ | $0.850$ |
...
| **Gold** | 3 |
| **Experience** | 0 |
| **Health** | $20-70 3$% of minion's **maximum** health |
| **Armor** | 0 |
| **Magic Resist** | 0 |
| **Damage** | 110% of minion's AD |
| **Damage Type** | Physical |
| **Attack Speed** | Melee / Ranged, they lose 58.3% attack speed by default |
| **Move Speed** | 505 |
| **Control** | Autonomous |
| **Targeting** | Minion, but does not count towards the minion kill tracking score |
...
- **Reborn:** *Void Remora* are summoned by all lane minions that are killed while ''Bel'Veth'* is within 1000 units of them including allied ones. They emerge from the Void after $0.75$ seconds of the minion dying. Each type of minion killed spawns a certain number of *Void Remora': * Blue Melee Minion - 1 Melee * Blue Caster Minion - 1 Ranged * Blue Siege Minion - 1 Melee and 1 Ranged * Blue Super Minion - 2 Melee and 2 Ranged
...
- **Consumable:** *Void Corals* are spawned from the corpses of epic monsters and champions that ''Bel'Veth'* has takedown. She may consume the *Void Coral* by casting *Endless Banquet* on it to embrace her *True Form*. They cannot be targeted by any unit but *'Bel'Veth''.
...
**Innate:** **Bel'Veth**’s attack speed cap is greatly increased, but her does not grow by xp. The damage dealt by her basic attacks (including on-hit effects) is reduced.
...
| **Affects** | Self, Enemies |
| **Damage Type** | Physical |
| **Speed** | $800-1000$ Dash speed units/second |
| **Spell Shield** | True |
...
*If this hits an enemy champion, it cdr **Void Surge*’s* dash cooldown of the target direction.*

**Active:** ''Bel'Veth'' slams her tail down in the target direction that deals magic damage to enemies hit, airborne for $0.75$ seconds, and slow them by 50% for a duration. If this hits an enemy champion, it resets **Void Surge*’s* dash *cooldown* of the target direction.
...
**Scaling:**
- **Bonus True Damage:** $6-10$ (+ 12% bonus AD)
- **Maximum Monster Damage:** $6×5-10×5$ (+ $12×5$% bonus AD)
...
### V14.9
- *Death in Lavender*
  - Bonus attack speed per *Lavender* stack reduced to 0.28–1 from 0.28–1. *Now scales until level 17 instead of 13.*
- *Void Surge*
