...
**ABLAZE:** While afflicted with *Ablaze*, the target is dealt magic damage equal toEach stack of *Ablaze* deals damage to the target individually and applies their damage ticks dependent on the time they were applied, even if the duration of all the stacks are refreshed. *Ablaze* deals 260% damage per tick to monsters; this damage is capped at
