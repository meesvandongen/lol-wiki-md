...
- *Revitalize* will record bonus shielding when a new shield is created, but not when it regenerates. In either case, there is no bonus shielding received.
...
*After a brief delay, he deals magic damage and briefly airborne nearby enemies.*

**Active:** **Rakan** dashes to the target location. After a $0.35$-second delay upon arrival, he deals magic damage to nearby enemies and airborne for 1 second. **Rakan will be knockdown by any immobilize or polymorph crowd control during the dash.**
...
**Passive:** **Rakan** can cast or re-cast *Battle Dance* at an increased *range* when targeting **Xayah**.

**Active:** **Rakan** shield the target allied champion for a short time, then dash to them. *Battle Dance* can be recast once with no cost.

**Active:** **Rakan** grants a shield to the target allied champion for 3 seconds and then dash to and around them. *Battle Dance* can be recast within 5 seconds at no additional cost. **Recast:** **Rakan** mimics the first cast's effects. **Rakan will be knockdown by any immobilize or polymorph crowd control during the dash.** *If **Xayah** is the target, Battle Dance can be cast from an increased range.*
...
- Stats
  ...
  - Armor growth reduced to $4.9$ from $5.1$.
...
- *Grand Entrance*
  - Base damage reduced to $70-270$ from $70-290$.
  - AP ratio increased to 80% AP from 70% AP.

### V12.22
- General
  - Range type changed to melee from ranged.
