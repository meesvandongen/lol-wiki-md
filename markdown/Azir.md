...
| Attribute | Value |
|-----------|------:|
| **Range** | 375 / 425 (Damage range) units |
| **Damage** | 0@1; 5@10; 10@11; 15@12; 20@13; 25@14; 30@15; 35@16; 40@17; 45@18 (+ 50 / 65 / 80 / 95 / 110) (+ 35 / 40 / 45 / 50 / 55% AP) |
| **Damage Type** | magic |
...
| **On-Hit** | *Sand Soldiers' * attacks are mitigated by block or dodge, likewise while **Azir** is blinded. |
...
- **Warden's Eye:** The *Sun Disc* gains true sight; it can see stealthed units within a 1000 radius of it.
...
| **Tether Radius** | 2000 units |
| **Static Cooldown** | 90 (Starts after Sun Disc is destroyed/expired) |
| **Targeting** | Unit |
...
*See [Pets](#Pets) for more details about the Sun Disc.*
...
| **Target Range** | 740 units |
| **Effect Radius** | 150 (Dashing soldier dash collision radius) units |
...
| **Tether Radius** | 660 (Soldier command range) units |
| **Cost** | 40 / 35 / 30 / 25 / 20 mana + 1 Sand Soldier |
| **Cooldown** | $1.5$ seconds |
| **Recharge** | 10 / 9 / 8 / 7 / 6 seconds |
| **Targeting** | Location |
| **Affects** | Enemies |
| **Damage Type** | Magic |
| **Spell Shield** | False |
...
| Attribute | Value |
|-----------|------:|
| **Magic Damage** | 0@1; 5@10; 10@11; 15@12; 20@13; 25@14; 30@15; 35@16; 40@17; 45@18 (+ 50 / 65 / 80 / 95 / 110) (+ 40 / 45 / 50 / 55 / 60% AP) |

Sand Soldiers cannot attack structures, wards, nor traps.

*See [Pets](#Pets) for more details about Sand Soldiers.*
...
| Attribute | Value |
|-----------|------:|
| **Shield Strength** | 70 / 110 / 150 / 190 / 230 (+ 60% AP) || Attribute | Value |
|-----------|------:|
...
| **Target Range** | 400 (Charge distance in front of Azir, wall location) / -325 (Starting location behind Azir, see notes) units |
| **Effect Radius** | 125 (Soldier radius, 'lollipop' radius where they come to halt) units |
| **Speed** | 1000 (Knockback missiles speed) / 1400 (Soldiers dash speed) units/second |
| **Cost** | 100 mana |
...
**ACTIVE:** **Azir** calls forth a phalanx of soldiers from 175 (See notes) units behind him, catching enemies from up to 325 (See notes) units behind him and charging forward 575 (See notes) units in the target direction.

| Attribute | Value |
|-----------|------:|
| **Width** | 6 / 6.5 / 7 / 7.5 / 8 soldiers |
| **Width (charge)** | er 620 / 670 / 720 / 770 / 820 |
| **Width (impassable wall)** | pathing radius 750 / 800 / 850 / 900 / 950 |
...
| Attribute | Value |
|-----------|------:|
| **Magic Damage** | 200 / 300 / 400 / 500 / 600 (+ 75% AP) |
...
- Arise!
  - AP ratio reduced to 40 / 45 / 50 / 55 / 60% AP from 45 / 50 / 55 / 60 / 65% AP.
...
- Arise!
  - AP ratio increased to 45 / 50 / 55 / 60 / 65% AP from 40 / 45 / 50 / 55 / 60% AP.
...
### V14.23
- Arise!
  - AP ratio increased to 40 / 45 / 50 / 55 / 60% AP from 35 / 40 / 45 / 50 / 55% AP.
...
- Arise!
  ...
  - AP ratio reduced to 35 / 40 / 45 / 50 / 55% AP from 55% AP at all ranks.
