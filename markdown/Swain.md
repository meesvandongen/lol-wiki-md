...
- *Death's Hand* will still cast and deal damage if **Swain** dies during the cast time. Effect at cast time end
...
- The pull will interrupt channels at the very beginning, but does not keep the target stunned for the rest of the movement.
  - Channels can be started successfully during the pull, provided the previous crowd control does not prevent them still. Effect at cast time start
