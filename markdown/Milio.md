...
**RECAST:** **Milio** commands the fuemigo to follow the target allied champion to within cr 150-units, placing the recast on a cd-second static (Unaffected by ability haste) cooldown.
